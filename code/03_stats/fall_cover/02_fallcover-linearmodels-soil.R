...
emmeans(m2, specs = ~ cctrt_id|till_id|straw_id, type = "response") |> 
  ...
  write_csv("data/stats/emmeans/starburst-emmeans-soilcover.csv")
...
#--this difference doesn't really match what I 'see'
...
#--so a difference of 3%, not meaningful, but the pairs says 15%
